...
page_fault_handler(struct Trapframe *tf) {
    ...
    // LAB 9: Your code here:
    uintptr_t user_rsp = tf->tf_rsp < USER_EXCEPTION_STACK_TOP && tf->tf_rsp > USER_EXCEPTION_STACK_TOP - PAGE_SIZE ? tf->tf_rsp - sizeof(uintptr_t) : USER_EXCEPTION_STACK_TOP;
